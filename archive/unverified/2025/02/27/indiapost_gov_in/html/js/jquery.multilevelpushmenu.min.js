	...
	$.fn.multilevelpushmenu = function( options ) {
		...
		this.each(function(){
			...
			var settings = $.extend({
				...
				backItemIcon: 'glyphicon glyphicon-chevron-left',
				groupIcon: 'glyphicon glyphicon-chevron-right',
				mode: 'overlap',
				overlapWidth: 40,
			...
			function createNestedDOMStructure( menus, $wrapper ){
				...
				$.each( menus, function(){
				    ...
				    var $title = $("<p />")
                    .attr({ "style": "height: 25px;font-size: 1.4em;line-height: 0.9em;font-weight: bold;color:inherit; padding: .3em .6em .4em .4em;text-align: " + ((instance.settings.direction == 'rtl') ? "right" : "left") })
                    .text((this.title == '') ? "Menu" : this.title)

					    .appendTo( $levelHolder ),
                        $titleImage = $("<span style='display: none;'/>")
			...
			function createItem() {
				var item = arguments[0],
				    ...
				    .text( item.name )
				    .appendTo( $item ),
                    $itemImage = $("<span style='display: none;'/>")
